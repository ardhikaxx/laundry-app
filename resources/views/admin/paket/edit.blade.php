    ...
    <div class="col-md-8 col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Ubah Data Paket: {{ $paket->kode_paket }}</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.paket.update', $paket) }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror" value="{{ old('harga', $paket->harga) }}" min="0" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.1" name="min_berat" class="form-control @error('min_berat') is-invalid @enderror" value="{{ old('min_berat', $paket->min_berat) }}" min="0">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $paket->deskripsi) }}</textarea>
